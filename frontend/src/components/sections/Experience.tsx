import { ExperienceContent, ExperienceEntry } from '../../types/resume';
            ...
            {data.entries.map((entry, entryIndex) => (
                <div key={entryIndex} className="p-4 bg-gray-50 border border-gray-100 rounded-xl space-y-3">
                    <div className="flex justify-between items-start">
                        <span className="text-sm font-medium text-gray-500">Experience {entryIndex + 1}</span>
                    ...
                    <div className="space-y-2">
                        <span className="text-sm font-medium text-gray-500">Achievements / Responsibilities</span>
